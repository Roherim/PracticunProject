...
<body>
	...
	<header>
		...
		<div id="Hed2"> <!--Первый блок шапки -->
			...
			<input placeholder size="10px"> <button>П</button><button>Глз</button><button>КОР</button>
		</div>
	...
	<div id="Contentpage">
		...
		<div id="centrepage">
			<div id="protab" align="center">
				<div class="Silv">
				<h5 align="center">Витрины, прилавки, повильоны</h5>
				</div>	
			</div>
		</div>
			<div id="Tab1">
					<ul class="products clearfix">
						<li class="product-wrapper">
							<a href="#" class="product"> <img src="Sours/product1.1.JPG"><button class="btn-ens-action" data-rel="a327f282205681">Купить</button></a>
							
						</li>
						<li class="product-wrapper">
							<a href="#" class="product"> <img src="Sours/product1.1.JPG"></a>
						</li>
						<li class="product-wrapper">
							<a href="#" class="product"> <img src="Sours/product1.1.JPG"></a>
						</li>
